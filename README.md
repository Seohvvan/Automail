...
> **바로 사용하기** — 배포된 앱에 접속해 바로 실행할 수 있습니다: **https://automail1398.streamlit.app/**
...
```
[구글 시트]  업체명 · 힌트 · 이메일 · 발견여부 · 제목 · 본문 · 발송여부
     │  (이메일 오른쪽 네 칸이 자동 지정: 이메일 F → 발견 G · 제목 H · 본문 I · 발송 J)
     │   발견/발송 여부는 O/X 로 기록되며, 후속 대응 탭은 발송 O 인 업체만 조회한다
     ▼
